...
## Project Structure
    ...
    ├── medication_schedule_43510  # Django project configurations
...
1. Clone this repo and `cd medication_schedule_43510`
...
2. Clone this repo and `cd medication_schedule_43510`
